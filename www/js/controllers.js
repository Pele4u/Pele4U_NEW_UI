    ...
    $scope.docActions = function() {
      ...
      if(2 === buttonsLength) {
        ...
        var hideSheet = $ionicActionSheet.show({
          ...
          buttons: [
            {text: '<i class="icon ion-checkmark-circled text-center"></i> אישור'}
          ],
          destructiveText: '<i class="icon ion-close-circled text-center"></i>דחיה',
          ...
          destructiveButtonClicked: function () {
            ...
            */
            ...
            if(undefined === note) {
              $ionicLoading.hide();
              $scope.$broadcast('scroll.refreshComplete');
              PelApi.showPopup(config_app.declineTitle , config_app.declineSubTitle);
            }else{
              ...
              if("wifi" === config_app.network){
                ...
                var links2 = PelApi.getDocApproveServiceUrl("SubmitNotif");
                var retSubmitNotification = PelApi.SubmitNotification(links2, appId, notificationId, note, actionType);
